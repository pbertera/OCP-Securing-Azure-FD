...
Is then possible to customize the router following the steps of the [Router customization in order to secure requests coming from an Azure Front Door](#router-customization-in-order-to-secure-requests-coming-from-an-azure-front-doorsecuring) Section
